...
* Actualización 20/10/2022. La versión 2.05, liberada el 16/09/2022 funciona con esta placa. Sólo es necesario actualizar la versión de Adafruit Pixel a la última disponible (1.10.6). Probada con el sketch que se incluye en la parte de abajo de este documento (Sketch Blink LED RGB en Arduino IDE).
